  ...
  return (
    <div className="min-h-full flex flex-col justify-center py-8 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center redhat-medium text-md text-gray-600">
          ¿Ya estás registrado?
          <Link
            to="/iniciar-sesion"
            ...
            <div className="redhat-medium text-sm">
              ...
              <div className="relative mt-1">
                <input
                  ...
                  required
                  onChange={handleChange}
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500"
                />
                <div
